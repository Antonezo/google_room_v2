export const translations = {
  ...
  RU: {
    ...
    introDialog: [
      ...
      "Почему именно 42 — я до сих пор пытаюсь выяснить...",
      "Ах да, меня зовут Айс, я буду твоим личным ассистентом и гидом!",
      "Но для начала мне нужно внести тебя в базу данных. Не переживай, это просто формальности..."
    ]
  }
};